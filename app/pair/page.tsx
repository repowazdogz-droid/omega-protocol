    ...
    <div style={{ padding: SPACING.standard, maxWidth: MAX_LINE_WIDTH, margin: '0 auto' }}>
      ...
      {!pairing ? (
        ...
        <UiCard style={{ marginBottom: SPACING.large }}>
          ...
          {/* QR Code */}
          {qrDataUrl ? (
            <div style={{ textAlign: 'center', marginBottom: SPACING.standard }}>
          ...
          {/* Info */}
          <div style={{ marginTop: SPACING.standard, padding: SPACING.small, opacity: 0.7 }}>
      ...
      {/* Info */}
      <div style={{ marginTop: SPACING.large, padding: SPACING.standard, opacity: 0.7 }}>
