...
export default function TeacherRecapPage() {
  ...
  return (
    <div style={{ padding: SPACING.standard, maxWidth: MAX_LINE_WIDTH, margin: '0 auto' }}>
      ...
      {data && !data.allowed && (
        <UiCard style={{ marginBottom: SPACING.large }}>
          <h2 style={{ fontSize: TEXT_SIZES.subheading, marginBottom: SPACING.standard }}>
            Access not granted
          </h2>
          <p style={{ fontSize: TEXT_SIZES.body, marginBottom: SPACING.standard }}>
            {data.visibilityNote || 'This learner has not granted access.'}
          </p>
          <div style={{ marginBottom: SPACING.standard, padding: SPACING.standard, backgroundColor: '#fff3e0', borderRadius: 4 }}>
          ...
          {requestMessage && (
            <div style={{ marginBottom: SPACING.standard, padding: SPACING.standard, backgroundColor: '#f5f5f5', borderRadius: 4 }}>
      ...
      {data && data.allowed && (
        <>
          {data.visibilityNote && (
            <div style={{ marginBottom: SPACING.standard, padding: SPACING.small, backgroundColor: '#e3f2fd', borderRadius: 4 }}>
          ...
          {data.nextPrompts && data.nextPrompts.length > 0 && (
            <UiCard style={{ marginBottom: SPACING.large }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: SPACING.standard }}>
      ...
      {/* Trust message */}
      {!data && !loading && (
        <div style={{ marginTop: SPACING.large, padding: SPACING.standard, backgroundColor: '#f5f5f5', borderRadius: 4 }}>
