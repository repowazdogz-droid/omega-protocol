        ...
        <UiCard style={{ marginBottom: SPACING.large }}>
          ...
          <div style={{ marginTop: SPACING.standard }}>
            ...
            {showReasoning && result.run.trace.length > 0 && (
              <div style={{ marginTop: SPACING.standard, padding: SPACING.standard, backgroundColor: '#f9f9f9', borderRadius: 4 }}>
          ...
          {result.thoughtObjects && result.thoughtObjects.length > 0 && (
            <div style={{ marginTop: SPACING.standard, padding: SPACING.standard, backgroundColor: '#e8f5e9', borderRadius: 4 }}>
